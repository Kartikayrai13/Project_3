...
public class UserModelTest {
	...
	public static void addTest() throws Exception {
		...
		dto.setFirstName("Guptaji");
		dto.setLastName("Rai");
		dto.setDob(sdf.parse("09-01-1997"));
		dto.setConfirmPassword("Qwerty@007");
		dto.setPassword("Qwerty@007");
		dto.setLogin("kartikay09@gmail.com");
		dto.setGender("male");
		...
		dto.setRoleId(1);
		dto.setMobileNo("9926314702");
		dto.setRegisteredIP("kartikayrai09@gmail.com");
		dto.setLoginIP("kartikayrai09@gmail.com");
